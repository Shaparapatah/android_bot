package pro.salebot.mobileclient.ui.views;
...
public class MySlidingMenu extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(mMenuWidth + mContentWidth, LayoutParams.MATCH_PARENT);
        Log.d("qweqweqwe", "onMeasure: ");
    }

    @Override
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //摆放Menu的位置，根据上面图可以确定上下左右的坐标
        mMenu.layout(-mMenuWidth, 0, 0, b);
        //摆放Content的位置
        mContent.layout(0, 0, mScreenWidth, b);
        Log.d("qweqweqwe", "onLayout: ");
    }
